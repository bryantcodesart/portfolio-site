...
export type LineProps = {
  ...
  Omit<
    ReactThreeFiber.Object3DNode<LineMaterial, [LineMaterialParameters]>, 'color' | 'vertexColors' | 'resolution' | 'args'
  >;

export const WorldUnitsLine = React.forwardRef<Line2, LineProps>((
  {
