...
export const ThreePage = ({ siteData }:{siteData:SiteData}) => {
  ...
  return (
    <>
      ...
      <main className="w-screen h-screen font-sans bg-white">
        <div
          className={`fixed top-0 left-0 text-[1rem] px-[1rem] py-[1rem] font-mono text-white bg-[red] tracking-wide ${showStats ? '' : 'z-[88888888]'} sm:px-[2rem]`}
          style={{
